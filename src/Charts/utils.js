...
export const combineChartDimensions = dimensions => {
  ...
  return {
    ...parsedDimensions,
    plotWidth: Math.max(parsedDimensions.width - parsedDimensions.marginLeft - parsedDimensions.marginRight, 0),
    plotHeight: Math.max(parsedDimensions.height - parsedDimensions.marginTop - parsedDimensions.marginBottom, 0),
  }
}
